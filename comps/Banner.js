    ...
    return (
      <section id="banner" className="flex justify-center py-10">
        ...
        <div className="flex-1 w-2/5 flex-grow">
          <p className="text-darkcolor font-P22Underground-book text-base leading-7 text-bold " >ROMEO POWER, INC. Media</p>
        ...
        <div className="flex-1 w-1/5">
          <ul>
            <li className="text-darkcolor font-P22Underground-book text-bold my-4 "><Link href="/media">Media</Link></li>
            <li className="text-darkcolor font-P22Underground-book text-bold my-4 "><Link href="/investors">Investors</Link></li>
            <li className="text-darkcolor font-P22Underground-book text-bold my-4 "><Link href="/about/careers">Careers</Link></li>
            <li className="text-darkcolor font-P22Underground-book text-bold my-4 "><Link href="/contact">Contact</Link></li>
          </ul>
        </div> 
        <div className="flex-1 w-2/5 flex-grow flex flex-col">
          ...
          <input 
          className=" rounded py-3 px-4  bg-opacity-50 bg-white border border-darkcolor my-2 " 
