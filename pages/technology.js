...
With ba ery technology, the greater the energy density and power density, the longer the range and the be er the acceleration. Our ba ery systems
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-8 py-12">
                ...
                <div className="w-1/2">
                    <p className=" text-left  font-P22Underground-thin text-lg">
                      ...
                      intelligent ba ery management system (BMS) in the Hermes
                      module to suit specific applications with proprietary algorithms
                      that enable rapid charge at optimal cycle life. Our ba ery
                    ...
                    <ul className="list-disc list-inside  py-4 ">
                      ...
                      <li className="font-P22Underground-thin py-1">Voltage and current measurement, fault detection and
                        ...
                        voltage buses and low-voltage system</li>
                                        <li className="font-P22Underground-thin py-1">Advanced ba ery state indicators (State of Charge (SOC), State
              ...
              <div className="w-1/2">
                ...
                INNOVATIVE THERMAL MANAGEMENT</h2>
                    ...
                    <p className=" text-left  font-P22Underground-thin text-lg">
                    For electric vehicles that go the distance, eﬀective ba ery thermal
                    management is key. Through innovative thermal management,
                    Romeo Power ba ery systems remain in the optimal temperature
                    range for safety, longevity and performance.
                      ...
                      <ul className="list-disc list-inside  py-4 ">
                        ...
                        <li className="font-P22Underground-thin py-1">In-house analysis capabilities with MATLAB in 0D/1D and Star-
                          CCM+ and Ba ery Design Studio in 3D space</li>

                        <li className="font-P22Underground-thin py-1">Perform detailed testing through state-of-the-art ba ery
                        cyclers and thermal chambers to validate the ba ery thermal
              ...
              <div className="flex gap-8 py-12">
                ...
                CELL SCIENCE + ENGINEERING</h2>
                    ...
                    demanding commercial ba ery-electric vehicle requirements,
                    enabling our customers to succeed.
                      ...
                      <ul className="list-disc list-inside  py-4 ">
                        <li className="font-P22Underground-thin py-1">Electrical, thermal and ba ery aging models validated against
proven cell data</li>
...
material selection and joining technologies</li>
          ...
          <div className="flex max-w-screen-lg  flex-wrap flex-1">
            <div className="flex-1">
              ...
              <p className=" text-left flex-1 font-P22Underground-thin text-lg py-4">
              Romeo Power’s ba ery safety design is rooted in extensive research. Through rigorous testing, we gain valuable data and an in-depth
understanding of critical ba ery safety designs.<br></br>
The result is a focused approach to management and mitigation of critical ba ery system failures, including thermal event mitigation through
