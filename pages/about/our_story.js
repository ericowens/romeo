...
{/* START */}
                ...
                <div className="grid grid-cols-2 gap-4 w-3/4">
                  ...
                  <h2 className=" text-left font-P22Underground-thp text-4xl font-bold ">March 2022</h2>
                    <p className=" text-left  flex-1 font-P22Underground-thin text-lg py-4">Romeo Power begins serial production for key customer</p>
